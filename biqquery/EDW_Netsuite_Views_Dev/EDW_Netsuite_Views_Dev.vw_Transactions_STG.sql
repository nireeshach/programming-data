...
FROM (
	...
	from `protean-impact-174217.netsuite.transactions`
	where date_last_modified >= '2018-06-20 20:30:00'
)												AS stg
LEFT OUTER JOIN `protean-impact-174217.netsuite.transaction_lines`				AS tl		ON stg.transaction_id = tl.transaction_id
LEFT OUTER JOIN `protean-impact-174217.netsuite.transactions`					AS t		ON stg.transaction_id = t.transaction_id
...
WHERE t.transaction_type = 'Inventory Transfer'
